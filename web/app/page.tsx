...
export default function Home() {
  return (
    <main className="min-h-dvh flex items-center justify-center p-3 sm:p-6">
      <div className="w-full max-w-lg rounded-2xl sm:rounded-3xl border border-(--border) bg-[rgba(17,21,19,0.78)] backdrop-blur-xl p-5 sm:p-8 md:p-10 relative overflow-hidden">
        {/* Glow top */}
